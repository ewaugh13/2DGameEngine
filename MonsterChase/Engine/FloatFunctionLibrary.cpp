...
inline bool FloatFunctionLibrary::AlmostEqualRelativeAndAbs(float i_A, float i_B, float i_maxDiff, float i_maxRelDiff)
{
...
inline bool FloatFunctionLibrary::AlmostEqualZeroCertain(float i_A, float i_maxCertDiff)
{
	return fabs(i_A) <= i_maxCertDiff;
}

inline bool FloatFunctionLibrary::IsNan(float i_A)
{
