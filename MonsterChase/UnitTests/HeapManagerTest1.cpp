...
//				{
//					void * pAllocatedPtr = AllocatedAddresses.back();
//					AllocatedAddresses.pop_back();
//
//					bool success = Contains(pHeapManager, pAllocatedPtr) && IsAllocated(pHeapManager, pAllocatedPtr);
//					assert(success);
//
//					success = free(pHeapManager, pAllocatedPtr);
//					assert(success);
//
//					numFrees++;
//				}
